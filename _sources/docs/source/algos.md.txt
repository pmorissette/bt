...
One of the core building blocks of bt is the {py:class}`Algo <bt.core.Algo>` and the
closely related {py:class}`AlgoStack <bt.core.AlgoStack>`.
...
argument that is the {py:class}`Strategy <bt.core.Strategy>` being tested. An Algo should ideally
...
{py:class}`bt.algos.RunMonthly`). If it has, this Algo return True, if not, False.

### Algo Stacks

An {py:class}`AlgoStack <bt.core.AlgoStack>` is a class that groups together many
...
the {py:class}`bt.algos.WeighEqually` Algo sets the 'weights' key in temp, and
...
- **selection**
  ...
  {py:class}`SelectAll <bt.algos.SelectAll>`,
  {py:class}`SelectThese <bt.algos.SelectThese>`,
  {py:class}`SelectWhere <bt.algos.SelectWhere>`,
  {py:class}`SelectN <bt.algos.SelectN>`,
  etc
- **weighting**
  How much weight should each of the selected securities have in the target
  portfolio? See, i.e.
  {py:class}`WeighEqually <bt.algos.WeighEqually>`,
  {py:class}`WeighRandomly <bt.algos.WeighRandomly>`
  {py:class}`WeighSpecified <bt.algos.WeighSpecified>`,
  {py:class}`WeighTarget <bt.algos.WeighTarget>`,
  {py:class}`WeighInvVol <bt.algos.WeighInvVol>`,
  {py:class}`WeighMeanVar <bt.algos.WeighMeanVar>`,
  etc
- **allocate**
  ...
  {py:class}`Rebalance <bt.algos.Rebalance>`
...
(for reporting). See, e.g. {py:class}`UpdateRisk <bt.algos.UpdateRisk>`.
...
{py:class}`bt.algos.WeighEqually` for an example.
:::

## Implementation

In most cases, Algos must preserve some kind of state. In this case, it is
easier to implement them as classes and define the \_\_call\_\_ method, like
below:
...
Recall that Algos should be reusable across different backtests (including
...
{py:class}`Security <bt.core.Security>` and
{py:class}`CouponPayingSecurity <bt.core.CouponPayingSecurity>`.
...
> - {py:class}`Debug <bt.algos.Debug>`
> - {py:class}`PrintTempData <bt.algos.PrintTempData>`
> - {py:class}`PrintInfo <bt.algos.PrintInfo>`
> - {py:class}`PrintRisk <bt.algos.PrintRisk>`
...
the {py:class}`Or Algo<bt.algos.Or>`.
