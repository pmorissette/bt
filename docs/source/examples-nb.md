...
{py:class}`Here is the code <bt.algos.SelectWhere>`.
:::
...
def ma_cross(ticker, start='2010-01-01', 
    ...
    # here we specify the children (3rd) argument to make sure the strategy
