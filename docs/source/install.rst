...
This environment allows you to plot your charts inline and also allows you to
easily add surrounding text with Markdown. You can easily create Notebooks that
you can share with collegues and you can also save them as PDFs. If you are not
yet convinced, head over to their webpage.
