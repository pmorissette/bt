...
1. **Market data generation**
   ...
   1. Corporate bonds with spreads driven by a common factor

1. **Example 1: Basic Strategies**

   1. Weigh all active corporate bond equally
   1. Add hedging of interest rates risk with the on-the-run government bond

1. **Example 2: Nested Strategies**

   1. One strategy buys the top N bonds, by yield
   1. Another strategy sells the bottom N bonds, by yield
   1. Parent strategy gives 50% weight to each of the above
   1. Add hedges of remaining interest rates risk with the on-the-run government bond
